...
- **Published eval scorecard**: LLM-simulated callers (interrupters, mumblers, topic-switchers) graded on task completion and caller safety — regenerated every release
- **Latency receipts**: measured TTFT breakdown, not vibes
